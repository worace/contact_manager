class EmailAddressesController < ApplicationController
  ...
  def destroy
    addr = @email_address.destroy
    respond_to do |format|
      format.html { redirect_to addr.contact, notice: 'Email address was successfully destroyed.' }
  ...
  private
    ...
    def email_address_params
      params.require(:email_address).permit(:contact_id, :address, :contact_type)
    end
end
